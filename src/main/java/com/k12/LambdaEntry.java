...
public class LambdaEntry {
    private static final String CHROME_HEADLESS_PACKAGE =
            "https://webdrivertesting-resources.s3.amazonaws.com/stable-headless-chromium-amazonlinux-2017-03.zip";
    private static final String CHROME_DRIVER =
            "https://webdrivertesting-resources.s3.amazonaws.com/chromedriver_linux64.zip";
    ...
    public String runCucumber(String feature) throws Throwable {
        ...
        try {
            ...
            sendEmail("alexeymspm@gmail.com", FileUtils.readFileToString(txtOutputFile, Charset.defaultCharset()));
    ...
    private void sendEmail(final String to, final String results) {
        try {
            ...
            final SendEmailRequest request = new SendEmailRequest()
                    ...
                    .withSource("alexeymspm@gmail.com");
